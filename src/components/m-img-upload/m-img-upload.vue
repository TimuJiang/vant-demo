<template lang="pug">
	.m-img-upload
		...
		van-action-sheet.imgShow(
			...
			upload-basic(:type="type" :operation="operation" :is-multiple="isMultiple" :title="title" :ids="ids" @do-upload="(data) => { $emit('do-upload', data); popupShow(false) }" @click-left="() => { popupShow(false) }")
</template>
